              ...
              examenes.map((examen, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TouchableOpacity
                      style={[styles.pdfButton, {backgroundColor: '#3498db', marginTop: 10}]}
                      onPress={() => {
                        const pdfUrl = `${API_URL}/generar-reporte-firma/${id}`;
                    ...
                    >
                      ...
                      <Text style={styles.pdfButtonText}>Reporte con Firma</Text>
                    </TouchableOpacity>
                  </Animatable.View>
                );
              })
